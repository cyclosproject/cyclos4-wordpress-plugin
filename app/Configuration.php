	...
	protected function initialize_settings() {
		if ( ! isset( self::$settings ) ) {
			...
			self::$settings = array(
				...
				'custom_cyclos_url'    => new Setting( 'login_form', __( 'Custom Cyclos frontend URL', 'cyclos' ), 'url', true, 'https://demo-ui.cyclos.org%p?sessionToken=%s', __( 'Custom frontend URL. Please leave blank unless you use a custom Cyclos frontend. You can use %s and/or %p for the token and return path variables.', 'cyclos' ) ),
