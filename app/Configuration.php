		...
		if ( ! isset( self::$settings ) ) {
			self::$sections = array(
				'general'    => array(
					...
					'intro' => __( 'With the Cyclos plugin you can let your WordPress website communicate with your Cyclos server. Please read the <a href="https://wiki4.cyclos.org" target="_blank">instructions</a> in our Wiki for a detailed explanation or if you encounter problems using the plugin.', 'cyclos' ),
				),
				'connection' => array(
					'label' => __( 'Connection', 'cyclos' ),
					'intro' => __( 'Configure the connection to your Cyclos server with the fields below. Please read the <a href="https://wiki4.cyclos.org" target="_blank">instructions</a> in our Wiki for a detailed explanation.', 'cyclos' ),
				),
				'login_form' => array(
					'label' => 'Login Form',
			...
			self::$settings = array(
				...
				'cyclos_url'           => new Setting( 'connection', __( 'Cyclos URL', 'cyclos' ), 'url', true, 'https://demo.cyclos.org', __( 'The Cyclos URL. Cyclos should have the REST API enabled (this is the default).', 'cyclos' ) ),
				'username'             => new Setting( 'connection', __( 'Username', 'cyclos' ), 'text', true, 'wp_admin_user', __( 'The Cyclos user to connect with. Please use a dedicated Cyclos user, with only the permissions needed for the Cyclos plugin to work.', 'cyclos' ) ),
				'password'             => new Setting( 'connection', __( 'Password', 'cyclos' ), 'password', true, '', __( 'The password of the Cyclos user to connect with. The password is not stored anywhere. It is only used once, together with the activation code below, to generate the accessclient token for you. The accessclient token is used for all further requests to your Cyclos server by this plugin.', 'cyclos' ) ),
